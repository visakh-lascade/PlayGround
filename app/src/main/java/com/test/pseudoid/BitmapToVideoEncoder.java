...
public class BitmapToVideoEncoder {
    ...
    public void startEncoding(int width, int height, File outputFile) {
        ...
        Log.d(TAG, "Initialization complete. Starting encoder...");
         ...
         Completable.fromAction(this::encode)
                ...
                .doOnError(throwable -> Log.e(TAG, "Error I MADE THIS encoding video: " + throwable.getMessage()))
                .subscribe();
    }
    ...
    private void encode() {
        ...
        while (true) {
            ...
            byte[] byteConvertFrame = getNV21(mWidth, mHeight, bitmap);
